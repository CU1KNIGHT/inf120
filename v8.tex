\section{Vorlesung 8 \href{https://tu-dresden.de/mn/math/algebra/das-institut/beschaeftigte/antje-noack/ressourcen/dateien/v120-1/MathMethInf08.pdf?lang=en}{(10.05.2019)}}
...
\begin{definition}[Konvergenz von Potenzreihen]
...
\item \textbf{Approximation von f(x)} durch Taylor-Polynome $p_n(x)$ von Grad $\leq$ n in der Umgebung  $x_0$
...
\end{enumerate}
\begin{remark}
\textbf{\href{https://tu-dresden.de/mn/math/algebra/das-institut/beschaeftigte/antje-noack/ressourcen/dateien/v120-1/MathMethInf08Zusatz.pdf?lang=en}{ sieh den Zusatz an (Das Taylor-Polynom eines Polynoms p(x) stimmt mit p(x) uberein).
}}\\
