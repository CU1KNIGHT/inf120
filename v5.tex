\section{Vorlesung 5 \href{https://tu-dresden.de/mn/math/algebra/das-institut/beschaeftigte/antje-noack/ressourcen/dateien/v120-1/MathMethInf05.pdf?lang=en}{(26.04.2019)} }
...
\begin{definition}
Ein Punkt $x_0 \in V$ heißt ein \textbf{Häufungspunkt von} D , falls es eine Folge $(x_n)_{n \in \mathbb{N} }$ gibt mit:\\
\[ \forall n : x_n \in D \text{ , } x_n \neq x_0 \text{ und } \lim_{n \to \infty}{x_n} = x_0 \]
\end{definition}
