...
\begin{tikzpicture}
    ...
    xlabel= $x$,
    ylabel= {$y$}]
        \addplot[only marks,mark size=1] { x/(x+1)};
    \end{axis}
\end{tikzpicture}
\begin{example}
    \[\]
...
\begin{definition}$$ \newline
        ...
        \[	\exists r \in \mathbb{R}_+ , \forall r \in \mathbb{N}: \underbrace{|x|}_{\mathclap{\text{Betrag einer reellen oder komplexer Zahl}}} \leqq r   \]
